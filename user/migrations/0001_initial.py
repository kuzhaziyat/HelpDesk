...
<<<<<<< HEAD
                ('post', models.CharField(choices=[('director', 'Директор'), ('HR', 'Работник отдела кадров'), ('headDivisin', 'Руководитель подразделения'), ('headDepartment', 'Начальник отдела'), ('worker', 'Сотрудник')], default='worker')),
=======
>>>>>>> e79d23115a47bde3304ac22fd24fba651f3a233c
...
<<<<<<< HEAD
=======
                ('post', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.PROTECT, to='user.post', verbose_name='Должность')),
>>>>>>> e79d23115a47bde3304ac22fd24fba651f3a233c
            ],
            options={
