    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requester', models.ForeignKey(limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.PROTECT, related_name='task_requester', to=settings.AUTH_USER_MODEL, verbose_name='Отправитель')),
                ...
                ('оrganization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='user.organization', verbose_name='Организация')),
