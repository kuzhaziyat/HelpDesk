...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='task',
            name='controluser',
            field=models.ForeignKey(blank=True, limit_choices_to={'is_active': True}, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='task_controller', to=settings.AUTH_USER_MODEL, verbose_name='Контролирующий сотрудник'),
        ),
        migrations.AddField(
            model_name='task',
            name='department',
